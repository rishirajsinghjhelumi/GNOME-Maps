 ...
 * of the JSON String, because images are cached as binary data.
 * The method removes these charachters, so that the JSON is a list of POIs.
 */
...
const POIRenderer = new Lang.Class({
    ...
    vfunc_render: function(tile) {
        ...
        // The tile has no data, so its a rendering error.
        ...
        /**
         * The render-complete emit signal in libchamplain is not fully introspectable,
         * so, the bindings are not working correctly.
         * Hence, the data parameter(second one) is passed as a property of the tile.
         * Bug #734628.
         */
        tile.data = this.data;
