...
const POIMapSource = new Lang.Class({
    ...
    _init: function() {
        ...
        this.QM.addSearchPhrase("amenity", "bench");
        this.QM.addSearchPhrase("shop", "books");
        this.QM.addSearchPhrase("amenity", "bus_station");
        this.QM.addSearchPhrase("highway", "bus_stop");
        this.QM.addSearchPhrase("amenity", "car_rental");
        this.QM.addSearchPhrase("shop", "car");
        this.QM.addSearchPhrase("shop", "department_store");
        this.QM.addSearchPhrase("waterway", "dock");
        ...
        this.QM.addSearchPhrase("shop", "fashion");
        this.QM.addSearchPhrase("amenity", "fast_food");
        this.QM.addSearchPhrase("amenity", "restaurant");
        this.QM.addSearchPhrase("shop", "food");
        this.QM.addSearchPhrase("amenity", "fuel");
        this.QM.addSearchPhrase("shop", "greengrocer");
        this.QM.addSearchPhrase("shop", "grocery");
        this.QM.addSearchPhrase("shop", "hardware");
        this.QM.addSearchPhrase("amenity", "health_centre");
        this.QM.addSearchPhrase("natural", "heath");
        this.QM.addSearchPhrase("amenity", "hospital");
        this.QM.addSearchPhrase("tourism", "hostel");
        this.QM.addSearchPhrase("amenity", "hotel");
        this.QM.addSearchPhrase("place", "houses");
        this.QM.addSearchPhrase("place", "islet");
        this.QM.addSearchPhrase("shop", "laundry");
        this.QM.addSearchPhrase("amenity", "library");
        this.QM.addSearchPhrase("amenity", "market");
        this.QM.addSearchPhrase("amenity", "marketplace");
        this.QM.addSearchPhrase("natural", "mud");
        this.QM.addSearchPhrase("place", "municipality");
        this.QM.addSearchPhrase("historic", "museum");
        this.QM.addSearchPhrase("shop", "music");
        this.QM.addSearchPhrase("railway", "narrow_gauge");
        ...
        this.QM.addSearchPhrase("shop", "shoes");
        this.QM.addSearchPhrase("amenity", "shop");
        this.QM.addSearchPhrase("amenity", "shopping");
        this.QM.addSearchPhrase("shop", "shopping_centre");
        this.QM.addSearchPhrase("leisure", "slipway");
        this.QM.addSearchPhrase("amenity", "social_club");
        this.QM.addSearchPhrase("place", "state");
        this.QM.addSearchPhrase("shop", "stationery");
        ...
        this.QM.addSearchPhrase("natural", "tree");
